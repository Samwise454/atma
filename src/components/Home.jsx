...
const Home = () => {
    const url = 'https://atma.esbatech.org/login.php';
    ...
    const [teCode, setTeCode] = useState(localStorage.getItem("atma"));
                ...
                if (vCodeArray.length !== 4) {
                    ...
                    // if (teCode == null) {
                        ...
                        .then(data => {
                            ...
                            hide_loader();
                            localStorage.setItem("atma", tCode);//session data
                            navigate('/Form');
                        })
                        .catch(error => {
    ...
    useEffect(() => {
        ...
        if (expire === true) {
            ...
            let targetDate = new Date("Aug 12, 2025 18:00:00").getTime();
  ...
  return (
    <div className='mainForm1 relative'>
      ...
      <form onSubmit={handle_form} action="#" className='bg-white shadow-sm border-t-2 rounded-md flex justify-center items-center h-auto flex-col mt-10 mb-20 mx-3'>
