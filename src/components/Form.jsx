...
const Form = () => {
    const url = 'https://atma.esbatech.org/form.php';
    ...
    const [who, setWho] = useState(localStorage.getItem("atma"));
    ...
    const handleImage = (e) => {
        ...
        let imgFile1 = document.querySelector("#imgData1");
        let imgFile2 = document.querySelector("#imgData2");

        let fileData1 = imgFile1.files[0];
        let fileData2 = imgFile2.files[0];

        imgFormData.append('image1', fileData1);
        imgFormData.append('image2', fileData2);
    ...
    <div className='mainForm'>
      <Nav></Nav>
        ...
        <h1 className='text-center bg-blue-950 rounded-sm m-8 text-white p-5 text-xl'>
            <b>
                ANAMBRA STATE ROAD TRAFFIC MANAGEMENT AGENCY/OCHA 
                BRIGADE REGISTRATION FORM
            </b>
        </h1>
        ...
        <form onSubmit={handleForm} action="#" id='tForm' className='tForm bg-white shadow-sm border-t-2 flex justify-center items-center h-auto py-15 flex-col m-8 mb-20'>
            ...
            <div className='text-left flex-col'>
                ...
                <p className="formLabel">Upload Passport Image:  </p>
                <div>
                    <input type="file" 
                ...
                <p className="formLabel mt-6">Upload Image of your voter's card: </p>
                <div>
                    <input type="file" 
                        onChange={handleImage} 
                        placeholder='Choose an Image' 
